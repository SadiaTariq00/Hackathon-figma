...
const ProductBox = ({ product }: { product: any }) => (
  <div className="relative  border-t border-[#0000001A] ">
...
const NewArrivals = () => {
  return(
    ...
    <main>
      ...
      <div className="w-full flex   justify-center items-center mt-10  bottom-72 relative border-t border-[#0000001A] ">
        <div className="w-[80%]">
          <div className="flex flex-col">
    
         <div className="flex justify-center items-center">
          <h1 className="text-black  sm:text-md md:text-3xl lg:text-3xl pt-4 text-center font-extrabold">TOP SELLINGS</h1>
