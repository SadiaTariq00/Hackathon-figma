  ...
  return (
    <>
      ...
      <div className="bg-[#F0F0F0] w-full h-auto pt-16 pb-8 px-4 sm:px-8 lg:px-20">
        ...
        {/* Divider */}
        <div className="border-t border-[#0000001A] mt-0 mb-4 bottom-40 relative"></div>

        {/* Footer Bottom Section */}
        <div className="flex justify-between items-center bottom-40 relative ">
          <div className="font-satoshi text-sm text-[#00000099]">Shop.co © 2000-2023, All Rights Reserved</div>
          <Image src={"/paylogo.png"} alt={"Paylogo2"} className="cursor-pointer" height={30} width={281} />
        </div>
      </div>
    </>
  );
